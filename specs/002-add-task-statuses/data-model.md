...
## New Entity: Status Color Map

A declarative mapping from status value to display color, used exclusively in the presentation layer (`src/shared/ui/colors.ts`).

| Status   | Color  | ANSI Code | Fallback (no TTY) |
|----------|--------|-----------|-------------------|
| pending  | plain  | (none)    | plain             |
| done     | green  | 32        | plain             |
| canceled | yellow | 33        | plain             |
| failed   | red    | 31        | plain             |
